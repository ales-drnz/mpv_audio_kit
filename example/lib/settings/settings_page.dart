...
const _entries = <_PageMeta>[
  _PageMeta(label: 'af', icon: Icons.equalizer_rounded, title: 'Filters', builder: _filters),
  _PageMeta(label: 'speed', icon: Icons.speed_rounded, title: 'Speed', builder: _speed),
  _PageMeta(label: 'pitch', icon: Icons.music_note_rounded, title: 'Pitch', builder: _pitch),
  _PageMeta(label: 'replaygain', icon: Icons.av_timer_rounded, title: 'ReplayGain', builder: _replaygain),
  _PageMeta(label: 'volume', icon: Icons.volume_up_rounded, title: 'Volume', builder: _volume),
  _PageMeta(label: 'audio', icon: Icons.settings_input_component_rounded, title: 'Audio Hardware', builder: _audio),
  _PageMeta(label: 'aid', icon: Icons.audiotrack_rounded, title: 'Audio Track', builder: _aid),
  _PageMeta(label: 'ao', icon: Icons.router_rounded, title: 'Audio Output', builder: _ao),
  _PageMeta(label: 'cache', icon: Icons.cached_rounded, title: 'Cache', builder: _cache),
  _PageMeta(label: 'demuxer', icon: Icons.dns_rounded, title: 'Demuxer', builder: _demuxer),
  _PageMeta(label: 'network', icon: Icons.cloud_rounded, title: 'Network', builder: _network),
  _PageMeta(label: 'tls', icon: Icons.enhanced_encryption_rounded, title: 'TLS', builder: _tls),
  _PageMeta(label: 'stream', icon: Icons.shutter_speed_rounded, title: 'Stream Silence', builder: _streamSilence),
  _PageMeta(label: 'cover', icon: Icons.image_rounded, title: 'Cover Art', builder: _coverArt),
  _PageMeta(label: 'chapter', icon: Icons.bookmark_rounded, title: 'Chapters', builder: _chapters),
  _PageMeta(label: 'ab-loop', icon: Icons.repeat_one_on_rounded, title: 'A-B Loop', builder: _abLoop),
  _PageMeta(label: 'hook', icon: Icons.cable_rounded, title: 'Hooks Lab', builder: _hooks),
  _PageMeta(label: 'prefetch', icon: Icons.fast_forward_rounded, title: 'Prefetch', builder: _prefetch),
  _PageMeta(label: 'playback', icon: Icons.timeline_rounded, title: 'Playback Info', builder: _playbackInfo),
  _PageMeta(label: 'file', icon: Icons.description_rounded, title: 'File Info', builder: _fileInfo),
  _PageMeta(label: 'about', icon: Icons.info_outline_rounded, title: 'About', builder: _about),
];
