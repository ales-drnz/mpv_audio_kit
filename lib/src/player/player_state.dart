...
abstract class PlayerState with _$PlayerState {
  const factory PlayerState({
    ...
    @Default(_kAutoDevice) Device audioDevice,

    /// All audio output devices detected by mpv.
    @Default(_kDefaultDevices) List<Device> audioDevices,
    ...
    @Default(Gapless.weak) Gapless gapless,

    /// ReplayGain configuration. Set via [Player.setReplayGain].
    @Default(ReplayGainSettings()) ReplayGainSettings replayGain,
    ...
    @Default(<Spdif>{}) Set<Spdif> audioSpdif,
    ...
    @Default(Format.auto) Format audioFormat,
    ...
    @Default(Channels.auto) Channels audioChannels,
