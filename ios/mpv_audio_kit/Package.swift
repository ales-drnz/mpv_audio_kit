...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libmpv",
            url: "https://github.com/ales-drnz/mpv_audio_kit/releases/download/libmpv-r13/libmpv_ios.xcframework.zip",
            checksum: "b460f99d7e52fe0263f22239984e45127b7703ec3207d7bf385928c54c2d3e61"),
        // mpvkit:remote:end
    ]
)
